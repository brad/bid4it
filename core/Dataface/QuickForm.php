	 ...
	 function validate(){
	 	...
	 	if ( $this->isSubmitted() ){
	 		...
	 		foreach ($this->_fieldnames as $field){
	 			...
	 			$res = $this->_record->validate($field, $el->getValue(), $params );
	 			if ( !$res){
	 				/*
	 				 *
...
END;
	 ...
	 *
	 */
	function &createNewRecordForm($tablename, $fieldnames=null){
	 ...
	 *
	 */
	function &createEditRecordForm(&$tablenameOrRecord, $fieldnames=null){
