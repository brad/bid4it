<?php include 'install/install_header.inc.php';?>
		<h2>Please select your installation action</h2>
		<ol class="main-menu">
			<li><a href="<?=$_SERVER['PHP_SELF']?>?-action=db2app">
			...
			<li>
				<a href="<?=$_SERVER['PHP_SELF']?>?-action=archive2app">
...
<?php include 'install/install_footer.inc.php';?>
