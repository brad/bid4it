...
/* Adapted from "Six MySQL/PHP functions to streamline development" http://builder.com.au/ */

function fnDatabaseExists($dbName, $oConn='') {
// Confirms existence of a MySQL database
$bRetVal = FALSE;
...
// Confirms connection to a MySQL database
...
//Returns an HTML table from SQL
if (!$oConn and !$oConn = @mysql_connect(DB_HOST, DB_USER, DB_PASSWORD)) {
$sRetVal = mysql_error();
} else {
