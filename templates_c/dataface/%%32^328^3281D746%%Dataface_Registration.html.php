<?php /* Smarty version 2.6.18, created on 2009-09-29 15:15:49
         compiled from Dataface_Registration.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'use_macro', 'Dataface_Registration.html', 20, false),array('block', 'fill_slot', 'Dataface_Registration.html', 21, false),array('block', 'define_slot', 'Dataface_Registration.html', 23, false),array('function', 'block', 'Dataface_Registration.html', 22, false),)), $this); ?>
<?php $this->_tag_stack[] = array('use_macro', array('file' => "Dataface_Main_Template.html")); $_block_repeat=true;$this->_plugins['block']['use_macro'][0][0]->use_macro($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<?php $this->_tag_stack[] = array('fill_slot', array('name' => 'main_section')); $_block_repeat=true;$this->_plugins['block']['fill_slot'][0][0]->fill_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php echo $this->_plugins['function']['block'][0][0]->block(array('name' => 'before_registration_form'), $this);?>

		<?php $this->_tag_stack[] = array('define_slot', array('name' => 'registration_form')); $_block_repeat=true;$this->_plugins['block']['define_slot'][0][0]->define_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php echo $this->_tpl_vars['registration_form']; ?>
		...
		<?php echo $this->_plugins['function']['block'][0][0]->block(array('name' => 'after_registration_form'), $this);?>
